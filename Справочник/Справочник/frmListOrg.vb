Public Class frmListOrg
    Public Sub CreateOrgList()
        ...
        Dim strQuery As String = "SELECT ИД, Организация FROM Организация ORDER BY Организация"
        ...
        lblCount.Text = "Всего организаций: "
    ...
    Private Sub frmListOrg_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        With Me
            .Text = "Организации"
            .Icon = My.Resources.org
    ...
    Private Sub tsbEdit_Click(sender As System.Object, e As System.EventArgs) Handles tsbEdit.Click
        ...
        Dim objFL1 As Организация = New Организация(intIDFL)
