Public Class frmListFL
    ...
    Public Sub CreateFLList()
        ...
        Dim strQuery As String = "SELECT ИД, Фамилия, Имя, Отчество FROM Физлицо ORDER BY Фамилия, Имя, Отчество"
        ...
        End With
            ...
            lblCount.Text = "Всего физических лиц: "
    ...
    Private Sub frmListFL_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        With Me
            .Text = "Физические лица"
            .Icon = My.Resources.fl
