Public Class Квалификация


    Private intID As Integer
    Private strQual As String
    ...
    Public Property Квалификация() As String
        Get
            Return strQual
        End Get
        Set(value As String)
    ...
    Public Sub New(ByVal intID As Integer)
        If ЕстьТакой(intID) = True Then
            ...
            Dim strQuery As String = "SELECT * FROM Квалификация WHERE ИД=" & intID
            Try
                ...
                While objDataReader.Read() = True
                    With Me
                        ...
                        .Квалификация = objDataReader.GetValue(1)
    ...
    Public Function ЕстьТакой(ByVal intID As Integer) As Boolean
        Dim strConnectionString As String = "Data Source=" & strDBFileName & ";User ID=Admin;Provider=Microsoft.ACE.OLEDB.12.0;OLE DB Services=-1"
        Dim strQuery As String = "SELECT COUNT(*) FROM Квалификация WHERE ИД=" & intID
    ...
    Public Function Add(ByVal objFL As Квалификация) As Boolean
        Dim strConnectionString As String = "Data Source=" & strDBFileName & ";User ID=Admin;Provider=Microsoft.ACE.OLEDB.12.0;OLE DB Services=-1"
        Dim strQuery As String = "INSERT INTO Квалификация(ИД,Квалификация) VALUES (" & objFL.ИД & ",'" & objFL.Квалификация & "')"
        Dim objConnection As New OleDb.OleDbConnection(strConnectionString)
    ...
    Public Function Edit(ByVal objFL As Квалификация) As Boolean
        Dim strConnectionString As String = "Data Source=" & strDBFileName & ";User ID=Admin;Provider=Microsoft.ACE.OLEDB.12.0;OLE DB Services=-1"
        Dim strQuery As String = "UPDATE Квалификация SET Квалификация='" & objFL.Квалификация & "' WHERE ИД=" & objFL.ИД
        Dim objConnection As New OleDb.OleDbConnection(strConnectionString)
    ...
    Public Shared Function Delete(ByVal intID As Integer) As Boolean
        Dim strConnectionString As String = "Data Source=" & strDBFileName & ";User ID=Admin;Provider=Microsoft.ACE.OLEDB.12.0;OLE DB Services=-1"
        Dim strQuery As String = "DELETE FROM Квалификация WHERE ИД = " & intID
        Dim objConnection As New OleDb.OleDbConnection(strConnectionString)
