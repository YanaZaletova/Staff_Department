Public Class frmListTypeDoc
    Public Sub CreateDocTypeList()
        ...
        Dim strQuery As String = "SELECT ИД, Тип_документа FROM Тип_документа ORDER BY ИД"
        ...
        lblCount.Text = "Всего типов документов: "
    ...
    Private Sub frmListTypeDoc_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        With Me
            .Text = "Типы документа"
    ...
    Private Sub tsbEdit_Click(sender As System.Object, e As System.EventArgs) Handles tsbEdit.Click
        ...
        Dim objFL1 As Тип_документа = New Тип_документа(intIDFL)
