Public Class frmOrg
    Dim objFL1 As Организация

    Private Sub frmOrg_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        ...
        With Me
            ...
            Select Case strFormMode
                Case "ADD"
                    objFL1 = New Организация(98754834)
                    .Text = "Новая организация"
                    .Icon = My.Resources.add

                Case "EDIT"
                    objFL1 = New Организация(intIDFL)
