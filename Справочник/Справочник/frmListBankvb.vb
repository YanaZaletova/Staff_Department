Public Class frmListBank
    Public Sub CreateBankList()
        ...
        Dim strQuery As String = "SELECT ИД, Банк FROM Банк ORDER BY Банк"
...
objCommand.ExecuteReader(CommandBehavior.CloseConnection)
    ...
    Private Sub frmListBank_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        With Me
            .Text = "Банки"
            .Icon = My.Resources.bank
    ...
    Private Sub tsbEdit_Click(sender As System.Object, e As System.EventArgs) Handles tsbEdit.Click
        ...
        Dim objFL1 As Банк = New Банк(intIDFL)
