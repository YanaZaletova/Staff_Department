Public Class frmListEduLevel
    Public Sub CreateLevelList()
        ...
        Dim strQuery As String = "SELECT ИД, Уровень_образования FROM Уровень_образования ORDER BY ИД"
...
objCommand.ExecuteReader(CommandBehavior.CloseConnection)
        ...
        lblCount.Text = "Всего уровней образования: "
    ...
    Private Sub frmEduListLevel_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        With Me
            .Text = "Уровни образоввания"
            .Icon = My.Resources.educ_level
    ...
    Private Sub tsbEdit_Click(sender As System.Object, e As System.EventArgs) Handles tsbEdit.Click
        ...
        Dim objFL1 As Уровень_образования = New Уровень_образования(intIDFL)
