Public Class frmListEO
    Public Sub CreateEOList()
        ...
        Dim strQuery As String = "SELECT ИД, Учебное_заведение FROM Учебное_заведение ORDER BY Учебное_заведение"
        ...
        lblCount.Text = "Всего учебных заведений: "
    ...
    Private Sub frmListEO_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        With Me
            .Text = "Учебные заведения"
            .Icon = My.Resources.eo
    ...
    Private Sub tsbEdit_Click(sender As System.Object, e As System.EventArgs) Handles tsbEdit.Click
        ...
        Dim objFL1 As Учебное_заведение = New Учебное_заведение(intIDFL)
