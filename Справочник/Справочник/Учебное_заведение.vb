Public Class Учебное_заведение
    ...
    Public Property Учебное_заведение() As String
        Get
            Return strInst
        End Get
        Set(value As String)
    ...
    Public Sub New(ByVal intID As Integer)
        If ЕстьТакой(intID) = True Then
            ...
            Dim strQuery As String = "SELECT * FROM Учебное_заведение WHERE ИД=" & intID
            Try
                ...
                While objDataReader.Read() = True
                    With Me
                        ...
                        .Учебное_заведение = objDataReader.GetValue(1)
        ...
        Else
            With Me
                .ИД = MaxID("Учебное_заведение", "ИД") + 1
                .Учебное_заведение = "(не указано)"
    ...
    Public Function ЕстьТакой(ByVal intID As Integer) As Boolean
        Dim strConnectionString As String = "Data Source=" & strDBFileName & ";User ID=Admin;Provider=Microsoft.ACE.OLEDB.12.0;OLE DB Services=-1"
        Dim strQuery As String = "SELECT COUNT(*) FROM Учебное_заведение WHERE ИД=" & intID
    ...
    Public Function Add(ByVal objFL As Учебное_заведение) As Boolean
        Dim strConnectionString As String = "Data Source=" & strDBFileName & ";User ID=Admin;Provider=Microsoft.ACE.OLEDB.12.0;OLE DB Services=-1"
        Dim strQuery As String = "INSERT INTO Учебное_заведение(ИД,Учебное_заведение) VALUES (" & objFL.ИД & ",'" & objFL.Учебное_заведение & "')"
        Dim objConnection As New OleDb.OleDbConnection(strConnectionString)
    ...
    Public Function Edit(ByVal objFL As Учебное_заведение) As Boolean
        Dim strConnectionString As String = "Data Source=" & strDBFileName & ";User ID=Admin;Provider=Microsoft.ACE.OLEDB.12.0;OLE DB Services=-1"
        Dim strQuery As String = "UPDATE Учебное_заведение SET Учебное_заведение='" & objFL.Учебное_заведение & "' WHERE ИД=" & objFL.ИД
        Dim objConnection As New OleDb.OleDbConnection(strConnectionString)
    ...
    Public Shared Function Delete(ByVal intID As Integer) As Boolean
        Dim strConnectionString As String = "Data Source=" & strDBFileName & ";User ID=Admin;Provider=Microsoft.ACE.OLEDB.12.0;OLE DB Services=-1"
        Dim strQuery As String = "DELETE FROM Учебное_заведение WHERE ИД = " & intID
        Dim objConnection As New OleDb.OleDbConnection(strConnectionString)
