Public Class frmCard
    Dim objFL1 As Банковские_карты

    Private Sub frmCard_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        ...
        With Me
            ...
            Select Case strFormMode
                Case "ADD"
                    objFL1 = New Банковские_карты(98754834)
                    .Text = "Новая карта"
                    .Icon = My.Resources.add

                Case "EDIT"
                    objFL1 = New Банковские_карты(intIDFL)
                    .Text = "Редактирование сведений о карте"
...
MessageBoxIcon.Error)
        ...
        Call frmListCard.CreateCardList()
        Me.Close()
