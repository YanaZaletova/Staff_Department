...
Partial Class frmSpec
    ...
    Private Sub InitializeComponent()
        ...
        ' cmdExit
        ' 
        cmdExit.Location = New Point(531, 100)
        ...
        ' cmdSave
        ' 
        cmdSave.Location = New Point(424, 100)
        ...
        ' textSpec
        ' 
        textSpec.Location = New Point(155, 60)
        textSpec.Margin = New Padding(3, 2, 3, 2)
        textSpec.Name = "textSpec"
        textSpec.Size = New Size(256, 23)
        textSpec.TabIndex = 23
        ' 
        ' Spec
        ' 
        Spec.AutoSize = True
        Spec.Location = New Point(32, 65)
        Spec.Name = "Spec"
